        ...
        <div className="w-full max-w-[1200px] mx-auto px-6 relative">
          <div className="relative z-10 flex flex-col items-center gap-16">
            <div className="relative w-full">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full">
                    ...
                    <div className="sm:w-1/2 w-full flex flex-col justify-center" style={{ minHeight: 'clamp(200px, 22vw, 260px)' }}>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        ...
                        <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>Node.js</span>
                        <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>PostgreSQL</span>
                      </div>
                    </div>
                  </div>
                </WindowCard>
             ...
             <div className="relative w-full">
               <div className="relative z-10">
                 <WindowCard href="https://devpost.com/software/plant-hopper" maxWidthClass="max-w-card" contentClassName="py-6 px-6 min-h-[340px] flex items-center">
                   <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full">
                     <div className="sm:w-1/2 w-full">
                       <div className="w-full bg-black rounded-2xl overflow-hidden" style={{ height: 'clamp(180px, 24vw, 240px)' }}>
                         <img
                           src="/photos/planthopper.jpeg"
                           alt="PlantHopper project"
                     ...
                     <div className="sm:w-1/2 w-full flex flex-col justify-center" style={{ minHeight: 'clamp(200px, 22vw, 260px)' }}>
                       <div className="flex items-center justify-between gap-3 mb-2">
                         <h2 className="font-semibold text-white" style={{ fontSize: 'clamp(18px, 1.6vw, 22px)' }}>PlantHopper</h2>
                         <div className="flex items-center gap-2 shrink-0">
                           <a href="https://github.com/austinjiann/planthopper" target="_blank" rel="noopener noreferrer" aria-label="PlantHopper GitHub" className="text-gray-300 hover:text-white transition-colors">
                           ...
                           <a href="https://devpost.com/software/plant-hopper" target="_blank" rel="noopener noreferrer" aria-label="PlantHopper Devpost" className="text-gray-300 hover:text-white transition-colors">
                             <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                               <path d="M18 13v6a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>
                               <path d="M15 3h6v6"/>
                               <path d="M10 14L21 3"/>
                       ...
                       <div className="flex flex-wrap gap-1.5">
                         ...
                         <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>Arduino</span>
                         <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>Firebase</span>
                         <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>Next.js</span>
                         <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>Tailwind CSS</span>
                         <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>React</span>
                       </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full">
                    ...
                    <div className="sm:w-1/2 w-full flex flex-col justify-center" style={{ minHeight: 'clamp(200px, 22vw, 260px)' }}>
                      ...
                      <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>Python</span>
                        ...
                        <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>TypeScript</span>
                        <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>Node.js</span>
                        <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>LangChain</span>
                        <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>Tailwind CSS</span>
                        <span className="px-2 py-0.5 bg-gray-700 text-gray-300 rounded-full" style={{ fontSize: 'clamp(11px, 1vw, 13px)' }}>Express.js</span>
                      </div>
                    </div>
                  </div>
                </WindowCard>
